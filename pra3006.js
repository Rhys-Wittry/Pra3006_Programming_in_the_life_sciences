...
// Run the queries for each species asynchronously
async function fetchData() {
  ...
  // After all queries are done, you can process the data further if needed
  console.log('Data for all species:', dataSet);
}

// Call the fetchData function to fetch data for all species
